<form method="GET" action="{{route('search')}}" id="search_app" class="header__search search">
    <input type="text" name="search" placeholder="Поиск по сайту" class="search__input input">
